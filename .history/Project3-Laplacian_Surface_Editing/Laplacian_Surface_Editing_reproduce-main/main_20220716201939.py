...
mesh = o3d.io.read_triangle_mesh('/Users/zqlwmatt/project/CV-project/Project3-Laplacian_Surface_Editing/Laplacian_Surface_Editing_reproduce-main/meshes/bun_zipper_res2.ply')
