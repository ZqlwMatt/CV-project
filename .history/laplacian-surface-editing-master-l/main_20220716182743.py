...
# --------------------------------- Load Mesh -------------------------------- #
mesh = trimesh.load('/Users/zqlwmatt/project/CV-project/laplacian-surface-editing-master-l/meshes/bunny.ply', process=False)
export_fn = '/Users/zqlwmatt/project/CV-project/laplacian-surface-editing-master-l/exports/bunny_%s.ply' % (time.strftime("%Y%m%d%H%M%S", time.localtime()) )
...
constraint_coef = np.matrix(constraint_coef) * 0.5
constraint_b = np.array(constraint_b) * 0.5
