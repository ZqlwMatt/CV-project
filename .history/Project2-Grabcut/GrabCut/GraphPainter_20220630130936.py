...
class GraphPainter():
    def __init__(self, image_path):
        ...
        self.mode = 0               # Paint mode : foreground (1) | background (2) | rect (default 3)
        self.lx, self.ly = 0, 0     # start point
        self.rx, self.ry = 0, 0
        self.windowname = "Please select the foreground region."
    ...
    def paint(self):
        ...
        while(1):
            ...
            if key == ord('c'):
                ...
                res = self.solver.grabCut((self.lx, self.ly), (self.rx, self.ry))
                break
            elif key == ord('0'):
